...
// Ported verbatim from the web's hireDeadline.test.ts. The rule is copied into this app, so its
// expectations are copied with it — that is what stops the phone and the browser describing the
// same hire differently.
