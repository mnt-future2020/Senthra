...
router.get("/positions/export.csv", requirePermission("inventory.export"), inventoryController.exportAllPositionsCsv);
...
router.get("/movements/export.csv", requirePermission("inventory.history"), requirePermission("inventory.export"), inventoryController.exportMovementsCsv);
