      ...
      {open &&
        ...
        createPortal(
          <>
            ...
            <div ref={menuRef} role="menu" aria-label="Purchase request actions" className={`anim-fade-in fixed z-[60] w-44 py-1 ${dropdownSurfaceCls}`} style={{ ...dropdownRadius, top: pos.top, bottom: pos.bottom, right: pos.right }}>
              {canEdit && (
