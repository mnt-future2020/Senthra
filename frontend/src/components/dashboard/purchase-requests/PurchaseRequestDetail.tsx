      ...
      <DetailHeader
        ...
        badges={
          <>
            ...
            {prf.sourceType === "reorder" && (
              <span className="rounded-full bg-[var(--accent-10)] px-2 py-0.5 text-[10px] font-extrabold uppercase tracking-wider text-[var(--accent)]" title="Generated by the Reorder workbench from live stock levels.">
                Reorder Workbench
              </span>
            )}
