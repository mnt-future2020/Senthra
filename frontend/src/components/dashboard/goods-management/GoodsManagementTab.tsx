...
// Loads the queue of active jobs filtered to this warehouse, shows per-kit-line
// planned / issued / available tallies, and opens JobScanPanel for a selected job.
            ...
            {queue.map((row) => {
              ...
              return visibleLines.map((line, lineIdx) => (
                <tr
                  ...
                  className="border-b border-[var(--border)] align-middle last:border-0 hover:bg-[var(--surface-2)] transition-colors"
                >
                  {lineIdx === 0 && (
                    <>
