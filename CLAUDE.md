...
- **Route protection**: `AuthGuard` gates dashboard *content* and redirects to `/login`; it renders *inside* the dashboard shell so the sidebar/topbar stay visible during the session check.
